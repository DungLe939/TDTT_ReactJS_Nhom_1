...
```typescript
listPlaces(options?: ExecuteQueryOptions): QueryPromise<ListPlacesData, undefined>;
...
```typescript
listPlaces(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<ListPlacesData, undefined>;
