...
```ts
import { useListCategories, useListFoods, useListFoodsByCategory, useGetFoodDetail, useGetShopDetail, useListShops, useListAllShopsWithMenu, useCreateCategory, useCreateShop, useCreateFoodItem } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListAllShopsWithMenu();
...
```js
import { listCategories, listFoods, listFoodsByCategory, getFoodDetail, getShopDetail, listShops, listAllShopsWithMenu, createCategory, createShop, createFoodItem } from '@dataconnect/generated';
...
// Operation ListAllShopsWithMenu: 
