const { listCategoriesRef, listFoodsRef, listFoodsByCategoryRef, getFoodDetailRef, getShopDetailRef, listShopsRef, createCategoryRef, createShopRef, createFoodItemRef, connectorConfig } = require('../index.cjs.js');
