const { createCategoryRef, createShopRef, createFoodItemRef, listCategoriesRef, listFoodsRef, listFoodsByCategoryRef, getFoodDetailRef, getShopDetailRef, listShopsRef, connectorConfig } = require('../index.cjs.js');
