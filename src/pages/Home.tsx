...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] selection:bg-orange-200">
      {/* ══ Unified Background Container ══ */}
      <div 
        className="relative w-full overflow-hidden"
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=1920&auto=format&fit=crop&q=85')`,
      ...
      >
        ...
        <div 
          ...
          style={{ background: 'rgba(5, 10, 30, 0.75)', backdropFilter: 'blur(3px)' }} 
        />
        ...
        <div className="relative z-10">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div className="lg:w-[55%] flex flex-col items-start text-left space-y-6">
                  <motion.div
                    ...
                    className="flex items-center gap-2 text-orange-400 font-bold text-sm tracking-wide bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20"
                  >
                  ...
                  <motion.h1
                    ...
                    className="text-5xl lg:text-[4rem] font-extrabold text-white leading-[1.1] tracking-tight drop-shadow-lg"
                  >
                    Khám Phá Thế Giới,<br />
                    <span className="text-orange-400">Qua Từng Món Ăn</span>
                  </motion.h1>
                  ...
                  >
                    Hương Vị Bản Địa giúp bạn khám phá, nhận diện và tận hưởng ẩm thực đích thực ở bất cứ nơi đâu.
                    Từ nhận diện món ăn tức thì tới dịch thuật thông minh.
                  </motion.p>
                  ...
                  >
                    <Link
                      to="/scan"
                      className="flex items-center justify-center gap-2 bg-[#F97316] text-white px-8 py-4 rounded-xl font-bold shadow-[0_10px_30px_-5px_rgba(249,115,22,0.5)] hover:-translate-y-0.5 hover:shadow-[0_15px_30px_-5px_rgba(249,115,22,0.6)] transition-all w-full sm:w-auto"
                    >
                    ...
                    <Link
                      to="/itinerary"
                      className="flex items-center justify-center bg-white/10 backdrop-blur-sm text-white border border-white/30 px-8 py-4 rounded-xl font-bold hover:bg-white/20 hover:-translate-y-0.5 transition-all w-full sm:w-auto"
                    >
                      Khám Phá Tính Năng
                    </Link>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="flex items-center justify-between sm:justify-start sm:gap-14 pt-8 w-full border-t border-white/15 mt-6"
                  >
                    <div>
                ...
                {/* Right: food image + floating card */}
                <motion.div
                ...
                >
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-black/40 aspect-[4/3] w-full border border-white/10">
                    <img
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-8 left-4 md:-bottom-12 md:-left-12 bg-white/95 backdrop-blur-md p-4 md:p-5 rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.35)] w-[90%] md:w-[340px] border border-white/50"
                  >
                    <div className="flex gap-4 items-center">
                      <div className="w-16 h-16 md:w-[72px] md:h-[72px] rounded-2xl overflow-hidden shrink-0 border-[3px] border-white shadow-sm bg-orange-50">
                        <img src="https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?q=80&w=400&auto=format&fit=crop" alt="Phở Bò" className="w-full h-full object-cover" />
                      </div>
          ...
          {/* ── SEARCH AREA ── */}
          <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-white/10">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1">
                <motion.h2
                  ...
                  viewport={{ once: true }}
                  className="text-3xl md:text-5xl font-extrabold text-white leading-tight mb-8"
                >
                  Xin chào <span className="text-orange-400">User</span>,<br />
                  bạn muốn ăn gì hôm nay?
                </motion.h2>

                <div className="relative flex items-center bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl overflow-hidden mb-8 focus-within:bg-white/15 focus-within:border-orange-400/50 transition-all duration-300">
                  <Search className="absolute left-6 w-6 h-6 text-white/40" />
                  <input
                    type="text"
                    value={searchQuery}
                    onChange={e => setSearchQuery(e.target.value)}
                    placeholder="Tìm kiếm món ăn, địa điểm..."
                    className="flex-1 pl-16 pr-4 py-5 md:py-6 text-lg text-white placeholder-white/30 outline-none bg-transparent font-medium"
                  />
                  {searchQuery && (
                    <button onClick={() => setSearchQuery('')} className="mr-4 p-2 rounded-full hover:bg-white/10 text-white/40 transition-colors">
                      <X className="w-5 h-5" />
                    </button>
                  )}
                  <button className="m-2 px-8 py-4 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-bold rounded-xl shadow-lg transition-all">
                    Tìm kiếm
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  {foodCategories.map((cat, i) => (
                    <motion.button
                      ...
                      className="flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl pl-2 pr-5 py-2 transition-all group"
                    >
              ...
              <div className="lg:w-[40%] relative hidden lg:flex items-center justify-center">
                 <div className="w-64 h-64 rounded-full overflow-hidden border-4 border-white/20 shadow-2xl relative">
                    <img src="https://images.unsplash.com/photo-1622087250339-9295c9ef442b?w=600&auto=format&fit=crop&q=60" alt="Food" className="w-full h-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                 </div>
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-white/10 rounded-full animate-[spin_20s_linear_infinite]" />
          ...
          {/* ── FEATURES GRID ── */}
          <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-white/10">
            <div className="text-center mb-16">
              <motion.div
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                className="inline-block px-4 py-1.5 bg-orange-500/10 border border-orange-500/20 rounded-full text-orange-400 font-bold text-sm mb-4"
              >
                Tính Năng Nổi Bật
              </motion.div>
              <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6">Trải Nghiệm Đỉnh Cao</h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">Sử dụng công nghệ AI tiên tiến nhất để giúp bạn kết nối với tinh hoa văn hóa và ẩm thực mọi lúc, mọi nơi.</p>
            </div>
          ...
          {/* Bottom spacer to let the background breathe */}
          <div className="h-20" />
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-96 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" />
      </div>
    </div>
  );
};
