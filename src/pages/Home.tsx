...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] selection:bg-orange-200">
      ...
      {/* ══ HERO — full-screen Landmark 81 background ══ */}
      <section
        className="relative w-full min-h-[calc(100vh-64px)] flex items-center"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{ background: 'rgba(4, 8, 25, 0.65)', backdropFilter: 'blur(1px)' }}
        />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <motion.div
          ...
          className="relative mt-8 mb-14 rounded-[2.5rem] overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-8 px-8 md:px-14 py-12">
            {/* Left: greeting + search + categories */}
            ...
            >
              <div className="w-52 h-52 rounded-full overflow-hidden border-4 border-white shadow-2xl shadow-orange-300/40">
                <img
                  src="https://images.unsplash.com/photo-1622087250339-9295c9ef442b?w=600&auto=format&fit=crop&q=60"
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-2 w-24 h-24 rounded-2xl overflow-hidden border-[3px] border-white shadow-xl"
              >
                <img src="https://plus.unsplash.com/premium_photo-1675865396004-c7b86406affe?w=300&auto=format&fit=crop&q=60" alt="Bún" className="w-full h-full object-cover" />
              </motion.div>
              <motion.div
                animate={{ y: [0, 8, 0] }}
                transition={{ repeat: Infinity, duration: 3.5, ease: 'easeInOut', delay: 0.5 }}
                className="absolute -bottom-4 -left-4 w-20 h-20 rounded-2xl overflow-hidden border-[3px] border-white shadow-xl"
              >
                <img src="https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?w=200&auto=format&fit=crop&q=60" alt="Chef" className="w-full h-full object-cover" />
              </motion.div>
              <motion.div
                animate={{ y: [0, -6, 0] }}
                transition={{ repeat: Infinity, duration: 4, ease: 'easeInOut', delay: 1 }}
                className="absolute top-8 -left-8 w-16 h-16 rounded-xl overflow-hidden border-2 border-white shadow-lg"
              >
                <img src="https://images.unsplash.com/photo-1547592180-85f173990554?w=150&auto=format&fit=crop&q=60" alt="Gỏi cuốn" className="w-full h-full object-cover" />
              </motion.div>
