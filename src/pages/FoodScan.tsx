...
import { Focus, MapPin, Star, ChevronLeft, ChevronRight, BookOpen } from 'lucide-react';
...
export const FoodScan = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] bg-neutral-900 overflow-hidden">
      {!result ? (
