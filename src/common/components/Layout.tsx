...
import { Map, ScanFace, Languages, Dices, Menu, X, User as UserIcon, LogOut, Code, Users, ShoppingCart } from 'lucide-react';
...
export const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/store', label: 'Cửa hàng', icon: <ShoppingCart className="w-5 h-5" /> },
  ];
