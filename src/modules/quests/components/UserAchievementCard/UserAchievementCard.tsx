      ...
      <div className="pt-12 px-6 pb-6 flex flex-col">
        <div className="flex justify-between items-start">
          <div className="min-w-0 flex-1">
            <h3 className="font-black text-neutral-800 text-xl tracking-tight truncate">{user.username}</h3>
            ...
            {stats.badges.length > 0 ? (
              stats.badges.map(badge => (
                ...
                >
                  ...
                  <span className="text-[9px] font-black text-neutral-500 uppercase tracking-tighter w-full text-center truncate">{badge.name}</span>
                </div>
              ))
            ) : (
